...
public class Script_Action_Scissors : MonoBehaviour {
    ...
    private void OnMouseDown()
    {
        ...
        if (currentTurn == 1)
        {
            ...
            this.transform.parent.GetComponent<ObjectScript>().player1Action = 3;
            this.transform.parent.GetComponent<ObjectScript>().currentTurn = 2;
        }
        else if (currentTurn == 2)
        {
            this.transform.parent.GetComponent<ObjectScript>().player2Action = 3;
        }
    }
}
